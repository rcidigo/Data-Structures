...
public class ShoppingCart {
    ...
    //static TreeMap<String, ArrayList<String>> carts= new TreeMap <>(); // treemap for shoppers carts
    
	static MyTreeMap<String, Integer>items= new MyTreeMap<String, Integer>();
	static MyTreeMap<String,ArrayList<String>> carts= new MyTreeMap<>();

	//static KMap<String, Integer> items= new KMap<>();
	//static KMap<String, ArrayList<String>> carts= new KMap<>();
 ...
 */
    ...
    { // need to format display and show price as well
    	...
    	for(int i=0; i<carts.get(cus).size();i++)
    	{
